...
keeps your project structure in a config file. A plain Swift Package works too: a folder with a
`Package.swift` in it.
...
- **Destinations**: everywhere you can run, meaning simulators, connected devices, and macOS.
...
- Browse the full [feature list](./overview.md#what-you-get).
