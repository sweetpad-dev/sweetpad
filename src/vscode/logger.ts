...
import type { LogContext, LogErrorContext, Logger as ILogger } from "../core/logger/types";
...
/**
 * VS Code-backed Logger. Writes a YAML-like block per message to a SweetPad
 * output channel and forwards each message as a Sentry breadcrumb so errors
 * carry the run-up context.
 */
