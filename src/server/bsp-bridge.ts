 ...
 * verbosity is controllable live via the `bsp.setLogLevel` RPC.
 */
export class BspBridge implements vscode.Disposable {
  private readonly statusBar: vscode.StatusBarItem;
  private readonly output: vscode.OutputChannel;
  private readonly showLogsCommand: vscode.Disposable;
  ...
  constructor() {
    ...
    this.showLogsCommand = vscode.commands.registerCommand("sweetpad.bsp.showLogs", () => this.output.show(true));
    this.statusBar.command = "sweetpad.bsp.showLogs";
