...
//! ([`sweetpad::cli::swiftpm`]), never xcodebuild. This oracle proves that view
...
use sweetpad::cli::resolve::Container;
use sweetpad::cli::swiftpm::{self, Manifest};

fn fixtures_root() -> PathBuf {
    Path::new(env!("CARGO_MANIFEST_DIR")).join("fixtures/_synthetic-spm-cli")
}
